@auth
	...
	<div class="list-group mb-4">
	  ...
	  <a href="/logout" class="list-group-item list-group-item-warning list-group-item-action"><i class="fa fa-sign-out-alt"></i> Logout</a>
	</div>
	@else
	<a href="/logout" class="btn btn-sm btn-danger w-100 mb-3">Logout</a>
	@endif
@else
<a href="/login" class="btn btn-sm btn-danger w-100 mb-3">Login</a>
@endauth